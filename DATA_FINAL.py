...
#fig_7 = px.histogram(AI_final, x='AI in media', y='Count', color='Gender',category_orders = category_orders_dict)
# show the chart
#fig_7.show()


# ### Graph 8 - Perception of AI in media 
...
#fig_8 = px.histogram(AI_final_merged_melt, x='AI in media is', nbins=20, color='Age', histnorm='percent')

#fig_8.update_layout(title='Perceptions of AI in Media by Gender', xaxis_title='AI Characters in Medias', yaxis_title='Percentage')

#fig_8.show()


# ### Graph 10 What people think AI can do to the world and society
...
#main_cols = ['Education']
#factors = ['Think logically and solve problems', 'Replicate human interaction', 'Interpret speech',
          # 'Learn new things', 'Run surveillance on people', 'Replace human jobs', 'Take over the world',
        #   'Feel emotion', 'Develop relationships with humans', 'Replace pets']
#
...
#fig_10 = px.histogram(AI_final_merged_melt, x='AI Capabilities', nbins=20, color='Education', histnorm='percent')

#fig_10.update_layout(title='AI Capabilities by Gender', xaxis_title='AI Capabilities', yaxis_title='Percentage')
#fig_10.show()


# ### Graph 11 - Graph shows the percentage of respondents who use AI in their everyday lives and the types of technology they use 

# In[395]:


#main_cols = ['Count']
#factors = ['Self-driving cars', 'Predictive text or search algorithms', 'Digital assistants ',
          # 'Digital recommendation systems', 'Roomba and other smart home devices', 'Big Data', 
          # 'Facial recognition', 'Wireless networks', 'Voice recognition', 'Virtual reality gaming']
#
#AI_final_merged_melt = pd.melt(AI_final, id_vars=main_cols, value_vars=factors, value_name='AI Applications')

#fig_11 = px.histogram(AI_final_merged_melt, x='AI Applications', histnorm='percent', 
                 # facet_col='variable', facet_col_wrap=2, barmode='group',height = 2000, width = 1050)
#fig_11.update_xaxes(showticklabels=True)

# Customize the plot
#fig_11.update_layout(title='AI Applications',
                 # xaxis_title='AI Applications in Daily Use',
                 # yaxis_title='Percentage')

# Rotate x-axis labels to improve readability
#fig_11.update_xaxes(tickangle=45)

# Show the plot
#fig_11.show()


# ### Graph 12 How many people think of AI as a caretaker or loved one and if people have affection for AI, and what people think the gender of AI is

# In[396]:


#AI_final_sorted = AI_final.sort_values(by=['AI as caretaker or loved one'])

#fig_12 = sp.make_subplots(rows=1, cols=2, subplot_titles=['Think AI as Care Taker', 'Have Affection for AI'])

#fig_12.add_trace(go.Histogram(x=AI_final_sorted['AI as caretaker or loved one'], nbinsx=10, name='AI as caretaker or loved one',
                             # marker=dict(color='blue')), row=1, col=1)

# Sort the DataFrame based on the desired column
#AI_final_sorted = AI_final.sort_values(by=['Affection for AI'])

#fig_12.add_trace(go.Histogram(x=AI_final_sorted['Affection for AI'], nbinsx=10, name='Affection for AI',
                             # marker=dict(color='pink')), row=1, col=2)
#fig_12.show()


# ### Do people think AI developers are ethical? and include insights from interviews

# In[397]:


#fig_13 = px.histogram(AI_final, x='Developers are ethical', y='Count', color = 'Age',category_orders = category_orders_dict)
# show the chart
#fig_13.show()
